          ...
          <nav className={'navbar navbar-default navBarDefault'}>
            ...
            <div id="navbar" className={'navbar-collapse collapse navBarCollapse'}>
              ...
              <ul className={'nav navbar-nav navBarUL navbar-right'}>
                <li><a href="https://twitter.com/intent/tweet?&text=Check out this GraphQL course for React developers by @HasuraHQ https://learn.hasura.io/graphql/react" target="_blank" rel="noopener noreferrer"><img className={'twitterIcon'} src={twitter} alt={'Twitter'} /></a></li>
                <li><a href="https://hasura.io/" target="_blank" rel="noopener noreferrer">hasura.io</a></li>
              </ul>
            </div>
          </nav>
        </div>
